...
(see the notes for additional details).~\cite{Hedin1965,Onida2002,StarkeKresse2012,MarieAmmarLoos2024}
...
In self-energy ADC, the frequency dependence of the proper self-energy can be represented 
through a resolvent acting in an auxiliary $(N\pm1)$-electron space. 
This leads naturally to a matrix representation in terms of effective intermediate states. 
A general four-point vertex is more complicated: it depends on three independent frequencies, 
which cannot in general be accommodated by a single resolvent. A different representation 
is therefore required, in which the frequency dependence is distributed among several 
channel-specific resolvents and coupling vertices.
