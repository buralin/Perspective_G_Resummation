...
the $ai$ sector associated with $Q^-$.  For the frequency integrations it is
convenient to absorb the phase appearing in the BSE convolution and define
the reduced direct-$\eh$ pair propagators
\begin{align}
