...
\end{equation}
\titou{For the direct-$\eh$ channel this expression is exactly the contribution
...
\begin{multline}
    \frac{1}{2\pi}
    \int\dd{x}
    \frac{-\ii G_{0,a}(x+\omega)G_{0,b}(x)}{x-A-\ii0^+}
    \\
    =
    \frac{1}
...
\begin{multline}
    \frac{1}{2\pi}
    \int\dd{x}
    \frac{-\ii G_{0,i}(x+\omega)G_{0,j}(x)}{x-A+\ii0^+}
    \\
    =
    -\frac{1}
